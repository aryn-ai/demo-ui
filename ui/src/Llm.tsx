...
export const rephrase_question_prompt = (text: string, conversation: any[]) => {
    ...
    const sys = "Given the following conversation and a follow up question, rephrase the follow up question to be a standalone question. If there is no conversation, return the question unchanged. \n"
